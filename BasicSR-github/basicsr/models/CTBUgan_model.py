...
class CTBUGANModel(SRGANModel):
    ...
    def __init__(self, opt):
        super(CTBUGANModel, self).__init__(opt)
    ...
    def inference(self, img):
        #pdb.set_trace()
        output_image, mask = self.net_g(img)
        return output_image
    ...
    def optimize_parameters(self, current_iter):
        ...
        if (current_iter % self.net_d_iters == 0 and current_iter > self.net_d_init_iters):
            ...
            if self.cri_pix:
                ...
                #l_g_pix = self.cri_pix(self.output, l1_gt, self.mask)
                l_g_total += l_g_pix
                loss_dict['l_g_pix'] = l_g_pix
            # mask loss
            if self.cri_mask:
                l_g_mask = self.cri_mask(self.pred_mask, self.mask)
                l_g_total += l_g_mask
                loss_dict['l_g_mask'] = l_g_mask
            if self.cri_ldl:
            ...
            if self.cri_perceptual:
                ...
                #l_g_percep, l_g_style = self.cri_perceptual(self.output, percep_gt, self.mask)
            ...
            #l_g_gan = self.cri_gan(fake_g_pred, True, self.mask, is_disc=False)
        ...
        #l_d_real = self.cri_gan(real_d_pred, True, self.mask, is_disc=True)
        ...
        #l_d_fake = self.cri_gan(fake_d_pred, False, self.mask, is_disc=True)
